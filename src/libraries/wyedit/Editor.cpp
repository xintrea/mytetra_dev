...
void Editor::hideAllToolsElements(void)
{
...
void Editor::insertButtonToToolsLine(QString toolName, QToolBar *line)
{
...
void Editor::assemblyButtons(void)
{

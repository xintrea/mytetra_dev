...
// 1.31.1 - Основана на версии 1.30.2
//        - Заменена библиотека шифрования RC5Simple на версию 1.30
//        - Исправлен баг, при котором не записывались последние изменения 
//          в записи, если он а была вырезана, а потом вставлена
//          (т. е. не запоминались изменения редактирование от момента 
//          открытия записи и до момента нажатия кнопки Cut)
//        - Исправлен перевод, теперь русскоязычные пользователи видят,
//          что с ветками возможны процедуры Вырезать/Копировать/Вставить
